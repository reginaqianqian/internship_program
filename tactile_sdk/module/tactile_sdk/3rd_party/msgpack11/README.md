...
* Using CMake
        ...
        # if you want to use it as a static lab and install it
        ...
        # if you just want to run some test and do not need to use it as a static lab or install it
        cd ./module/tactile_sdk/3rd_party/msgpack11/
        mkdir build
        cd build
        cmake .. -DMSGPACK11_BUILD_TESTS=ON -DMSGPACK11_STANDALONE_BUILD=ON
        make
        ./test/basic
        ./test/raw
        ./test/array
